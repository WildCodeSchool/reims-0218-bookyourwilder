                  ...
                  <fieldset id="fsWilder">
                    ...
                    <fieldset class="form-group">
                      <div class="row justify-content-around">
                        ...
                        <label for="inputPassword" class="col-12 col-sm-5">Password</label>
                      </div>
                      <div class="row justify-content-around">
                        <input name="mail" type="text" class="form-control col-12 col-sm-5" id="inputMail" placeholder="${wilder.mail}">
                        <input name="password" type="text" class="form-control col-12 col-sm-5" id="inputPassword" placeholder="${wilder.password}">
                      </div>
                    </fieldset>
